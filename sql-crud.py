...
david_bowles = Programmer(
    first_name="David",
    last_name="Bowles",
    gender="M",
    nationality="British",
    famous_for="Coding improver but having FUN!"
)
...
# updating multiple records, commit needs to be part of the loop itsef!
